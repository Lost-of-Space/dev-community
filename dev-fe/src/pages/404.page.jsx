...
const PageNotFound = () => {
  return (
    <section className="h-cover relative p-10 flex flex-col items-center gap-3 text-center">
      ...
      <p>You can return to the <Link to="/" className="text-royalblue underline">Home Page</Link></p>

      <div className="mt-auto">
        <img src={logo} alt="Dev Space logo" className="h-20 object-contain block select-none" />
        <p className="text-dark-grey -mt-4">Maybe you wanna explore another page?</p>
      </div>
    </section>
  )
}
